/****************************************************************************
** Meta object code from reading C++ file 'dashboard_controller.h'
**
...
#error "The header file 'dashboard_controller.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 20, 19), // "new_device_on_topic"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 11), // "std::string"
QT_MOC_LITERAL(4, 53, 5), // "topic"
QT_MOC_LITERAL(5, 59, 14) // "device_deleted"

    },
    "DashboardController\0new_device_on_topic\0"
    "\0std::string\0topic\0device_deleted"
};
...
void DashboardController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->new_device_on_topic((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 1: _t->device_deleted((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DashboardController::*)(std::string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DashboardController::new_device_on_topic)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DashboardController::*)(std::string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DashboardController::device_deleted)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DashboardController::new_device_on_topic(std::string _t1)
{
...
// SIGNAL 1
void DashboardController::device_deleted(std::string _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
